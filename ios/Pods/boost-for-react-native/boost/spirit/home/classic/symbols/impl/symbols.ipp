...
//
///////////////////////////////////////////////////////////////////////////////
template <typename Loader, typename CharT, typename SetT>
inline symbols<Loader, CharT, SetT>::symbols()
: SetT()
, add(*this)
{
}
...
//////////////////////////////////
template <typename Loader, typename CharT, typename SetT>
symbols<Loader, CharT, SetT>::symbols(symbols const& other)
: SetT(other)
...
, parser<symbols<Loader, CharT, SetT> >()
#endif
, add(*this)
{
}
...
//////////////////////////////////
template <typename Loader, typename CharT, typename SetT>
inline symbols<Loader, CharT, SetT>&
symbols<Loader, CharT, SetT>::operator=(symbols const& other)
{
    SetT::operator=(other);
    return *this;
}
...
//////////////////////////////////
template <typename Loader, typename CharT, typename SetT>
inline symbol_inserter<Loader, SetT> const&
symbols<Loader, CharT, SetT>::operator=(CharT const* str)
{
    return add, str;
}
...
template <typename Loader, typename CharT, typename SetT>
inline Loader*
find(symbols<Loader, CharT, SetT> const& table, CharT const* sym)
{
    CharT const* last = sym;
    while (*last)
        last++;
    scanner<CharT const *> scan(sym, last);
    Loader* result = table.find(scan);
...
template <typename Loader, typename CharT, typename SetT>
inline Loader*
add(symbols<Loader, CharT, SetT>& table, CharT const* sym, Loader const& data)
{
