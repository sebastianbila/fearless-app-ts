...
///////////////////////////////////////////////////////////////////////////////
//  from numerics.hpp
    template <typename Loader, int Radix, unsigned MinDigits, int MaxDigits>
    inline std::string
    parser_name(uint_parser<Loader, Radix, MinDigits, MaxDigits> const& p)
    {
    ...
    template <typename Loader, int Radix, unsigned MinDigits, int MaxDigits>
    inline std::string
    parser_name(int_parser<Loader, Radix, MinDigits, MaxDigits> const& p)
    {
        BOOST_SPIRIT_SSTREAM stream;
        stream << Radix << ", " << MinDigits << ", " << MaxDigits;
    ...
    template <typename Loader, typename RealPoliciesT>
    inline std::string
    parser_name(real_parser<Loader, RealPoliciesT> const& p)
    {
