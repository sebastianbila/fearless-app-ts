...
inline void
dyn_symbol( Loader& res, char const* module_name, char const* symbol_name )
{
    ...
    res = reinterpret_cast<Loader>( ::GetProcAddress( m, symbol_name ) );
}
...
start_gdb_in_xterm( dbg_startup_info const& dsi )
{
    ...
    safe_execlp( "xterm", "-Loader", title, "-display", dsi.display.begin(),
